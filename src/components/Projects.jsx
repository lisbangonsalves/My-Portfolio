        ...
        <div className="projectswidget">
          ...
          <div className="project-desc">
            ...
            <div className="project-details">
              <p>
              Music Lyrics is a flutter application developed using Bloc Pattern which provides the lyrics for a particular music selected by the user among the provided list of music. The app uses the MusixMatch API to fetch data of the particular songs and list its details and provide its Lyrics. &#127926;
              </p>
            </div>
            <div className="project-links">
              <a href="https://github.com/lisbangonsalves/Music-Lyrics" target="_blank">
                <svg
                  viewBox="0 0 20 20"
                  fill="none"
              ...
              <svg viewBox="0 0 82 97" fill="none" xmlns="http://www.w3.org/2000/svg">
